...
import heroImage from "@/assets/profile-hero-new.png";
        ...
        <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
          ...
          >
            <div className="relative max-w-xs md:max-w-sm mx-auto">
              {/* Glow Effect */}
              <div className="absolute inset-0 bg-gradient-to-t from-gold/30 via-gold/10 to-transparent rounded-2xl blur-2xl scale-110" />
          ...
          >
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-black leading-tight mb-6 tracking-tight">
              <span className="bg-gradient-to-r from-gold via-gold-light to-silver bg-clip-text text-transparent drop-shadow-lg">
                {t("hero.headline")}
              </span>
            </h1>
            ...
            <motion.div
              ...
              className="inline-flex items-center gap-3 bg-card border border-border rounded-lg px-5 py-3 shadow-lg mb-10"
            >
